        ...
        <>
            ...
            <div className="flex flex-row my-20 w-full">
                ...
                >
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image6.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image9.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image11.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image13.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image14.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image15.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image16.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image17.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image18.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image19.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image20.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image21.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image22.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image23.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image24.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image25.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] pt-5 rounded-lg">
                        <div className="flex flex-col justify-between items-center md:w-[50%] mx-auto">
                            <Image src={'/image26.jpg'} className='shadow-2xl' />
                    ...
                    <SwiperSlide className="bg-[#deebfe] py-10 rounded-lg">
                        <div className="md:w-[70%] mx-auto">
                            <Image src={'/thankyou.jpg'} className='shadow-2xl' />
                        </div>
                    </SwiperSlide>
                </Swiper>
                <button
